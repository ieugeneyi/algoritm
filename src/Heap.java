...
public class Heap<E> {
    ...
    public E remove(){
        ...
        E result = (E) array[1]; //삭제된 요소를 반환하기 위한 임시변수
    ...
    private void siftDownComparator(int idx, E target, Comparator<? super E> comp){
        ...
        /*
         * 용적의 사이즈가 최소 용적 보다는 크면서 요소의 개수가 전체 용적의 1/4일 경우
         * 용적을 반으로 줄임(단, 최소 용적 보다는 커야함)
         */
